console.log("Hi There My first JS code!")

console.log(document.querySelector('.heyo'))

let greetingDiv = document.querySelector('.heyo')

heyoDiv.textcontent = 'Welcome to my page! This messgage was generated by my JS code!'
